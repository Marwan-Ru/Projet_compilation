...
lexyacc : cleanTarget $(CIBLELEXYACC).tab.c lex.yy.o obj/tableLex.o obj/tablereg.o obj/pile.o obj/liste.o obj/arbreAbstrait.o obj/allocation.o obj/tableTypes.o
